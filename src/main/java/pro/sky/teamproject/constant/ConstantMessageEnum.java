...
public enum ConstantMessageEnum {
    ...
    WARNING_FORGET_REPORT("Дорогой усыновитель, мы заметили, что отчет не был отправлен своевременно." +
    ...
    WARNING("Дорогой усыновитель, мы заметили, что ты заполняешь отчет не так подробно, как необходимо." +
            " Пожалуйста, подойди ответственнее к этому занятию. В противном случае волонтеры приюта будут обязаны" +
            " самолично проверять условия содержания животного."),
    GREETING_MESSAGE("Поздравляем, Вы прошли испытательный срок"),
    FAILED_MESSAGE("К сожалению, вы не прошли испытательный срок, " +
            "\nниже приведены инструкции,что необходимо сделать:" +
            "\nПодготовить животное" +
            "\nЖдать звонка волонтера"),
